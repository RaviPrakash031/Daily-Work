...
class Patients{
  ...
  public Patients(String name,int age,String gender,long aadharCardNumber,long contactNumber,String city,String address,String dateOfAdmission,String guardiansName,String guardiansAddress,long guardiansContact){
    this.id=nextId++;
    this.name=name;
    this.age=age;
    this.gender=gender;
...
class Hospital{
  ...
  List<Patients> getAgeGroup(int maxAge,int minAge){
   List<Patients> byAge=new ArrayList<>();
    ...
    /*List<Patient> getPatientByAgeGouop(int maxAge,int minAge){
      List<Patient> inAge=new ArrayList<>();
  ...
  public void deletePatientDetails(int id){
    ...
    patients.remove(id);
      ...
      System.out.println("There is no patient details to delete");
    }
  }
...
public class ArogyaHospitalProgram{
  public static void main(String [] args){
    ...
    Patients p=new Patients(Name,age,gender,aadharCardNumber,contactNumber,city,address,dateOfAdmission,gurdiansName,guardiansAddress,guardiansContact);
